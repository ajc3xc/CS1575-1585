...
#include <memory>
#include "../TextFinderApplication/textfinder.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_TextFinder_t, stringdata0) + ofs), len 
...
const QMetaObject TextFinder::staticMetaObject = { {
    ...
    qt_meta_stringdata_TextFinder.offsetsAndSize,
    qt_meta_data_TextFinder,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_TextFinder_t
